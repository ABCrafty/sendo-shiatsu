...
<table class="table table-hover witness">
    ...
    <tbody>
        <?php $__currentLoopData = $witnesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $witness): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr data-id="<?php echo e($witness->id); ?>">
            <td><?php echo e($witness->title); ?></td>
            <td><?php echo e($witness->content); ?></td>
            <td><?php echo e($witness->author); ?></td>
            <td><?php echo e(date('d/m/Y H:i', strtotime($witness->created_at))); ?></td>
            <td>
